            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('categories.update', $category->id) }}">
                        ...
                        <!-- Name -->
                        <div>
                            <x-input-label for="name" :value="__('ชื่อหมวดหมู่ (Category Name)')" />
                        ...
                        <!-- Description -->
                        <div class="mt-4">
                            <x-input-label for="description" :value="__('รายละเอียด (Description)')" />
                        ...
                        <div class="mt-4">
                            <label for="is_active" class="inline-flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-600">{{ __('เปิดใช้งานทันที (Active)') }}</span>
                            </label>
